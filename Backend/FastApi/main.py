...
"""para ejecutar el servidor local en uvicorn hay que poner en terminal: 
uvicorn main(nombre del fichero):app(nombre de la variable a la que hemos asignado fastapi) --reload(para que se recargue automaticamente
"""
